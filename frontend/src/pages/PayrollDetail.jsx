  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow mb-6">
        ...
        {payroll.has_active_claim && (
          <div className="mx-4 md:mx-6 mb-4 bg-orange-50 border border-orange-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-orange-600 mt-0.5" />
              <div className="flex-1">
                <h3 className="font-semibold text-orange-900">Reclamo pendiente</h3>
                <p className="text-sm text-orange-800 mt-1">
                  Esta nómina tiene un reclamo pendiente del empleado.
                </p>
              </div>
              <button
                onClick={() => navigate('/payroll-claims')}
        ...
        <div className="p-4 md:p-6">
          ...
          {payroll.hours_by_type && Object.keys(payroll.hours_by_type).length > 0 && (
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg mb-6 border border-blue-200">
              <h3 className="font-semibold text-gray-900 mb-3">Resumen de Horas por Tipo</h3>
