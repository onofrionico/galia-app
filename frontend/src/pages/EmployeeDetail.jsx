    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Detalle del Empleado</h1>
        </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-white/90">
                <div className="flex items-center gap-2">
                  <Briefcase size={16} />
                  <span>{employee.job_position?.name || 'Sin puesto asignado'}</span>
                </div>
        ...
        <div className="p-6 space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-900">
                    ...
                    {employee.age && <span className="text-gray-500 ml-2">({employee.age} años)</span>}
                  </div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-900">{employee.dni}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <User size={18} className="text-gray-400 mt-1" />
                <div>
                  <div className="text-sm text-gray-500">CUIL</div>
                  <div className="text-gray-900">{employee.cuil}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <div className="text-sm text-gray-500">Puesto Actual</div>
                <div className="text-gray-900 font-medium">{employee.job_position?.name || 'Sin asignar'}</div>
                {employee.job_position && (
                  <div className="mt-1">{getContractTypeBadge(employee.job_position.contract_type)}</div>
                )}
              </div>
              <div>
                <div className="text-sm text-gray-500">Tipo de Relación Laboral</div>
                <div className="text-gray-900 capitalize">{employee.employment_relationship}</div>
              </div>
              <div>
